#!/usr/bin/env python3
"""Run DAPR U-Net hyperparameter sensitivity end to end."""
...
try:
    from .dapr_hyperparameter_spec import DEFAULT_MODELS_CSV, DEFAULT_SEEDS
except ImportError:
    from dapr_hyperparameter_spec import DEFAULT_MODELS_CSV, DEFAULT_SEEDS
...
def main() -> None:
    ...
    if args.run_tests:
        run([
            ...
            "tests/test_dapr_hyperparameters.py",
    ...
    run([
        py, str(PROJECT_ROOT / "scripts" / "report_dapr_hyperparameters.py"),
        "--summary-path", str(test_summary),
    ...
    print("\nDAPR U-Net hyperparameter sensitivity completed successfully.")
