...
DEFAULT_MODELS = "unet,unetpp,attention_unet,pranet,acsnet,hardnet_mseg,cfanet,polyp_pvt,caranet,hsnet,resunetpp,dapr_unet"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-dir", type=str, default="configs/fair", help="Directory containing <model>.yaml")
