...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-dir", type=str, default="configs/fair", help="Directory containing <model>.yaml configs")
...
def main() -> None:
    ...
    for model in models:
        cmd = [sys.executable, str(script), "--model", model, "--dataset", args.dataset]
